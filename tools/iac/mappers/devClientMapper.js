...
let clientArray = [
  {
    clientId: "childcare-ecer-api-dev",
    ...
    protocolMappers: [
      ...
      },
      {
        ...
        consentRequired: false,
        config: {
          "included.client.audience": "childcare-ecer-api-dev",
  ...
  },
  {
    ...
    redirectUris: [
      ...
      "http://localhost:5121/*",
      "https://efxdev-ecer-registry-portal.apps.silver.devops.gov.bc.ca/*",
    ],
    webOrigins: ["+"],
    notBefore: 0,
    bearerOnly: false,
    ...
    protocolMappers: [
      ...
      },
      {
        ...
        consentRequired: false,
        config: {
          "included.client.audience": "childcare-ecer-dev",
          "id.token.claim": "false",
          "access.token.claim": "true",
  ...
  {
    clientId: "childcare-ecer-ew-dev",
    name: "EW api user",
    description: "",
    rootUrl: "",
    adminUrl: "",
    ...
    protocolMappers: [
      ...
      },
      {
        ...
        consentRequired: false,
        config: {
          "included.client.audience": "childcare-ecer-ew-dev",
          "id.token.claim": "false",
  ...
  {
    clientId: "childcare-ecer-psp-dev",
    name: "ECER PSP Portal Client",
    description: "client used for ECER psp portal login",
    rootUrl: "",
    adminUrl: "",
    baseUrl: "https://dev-ecer-psp-portal.apps.silver.devops.gov.bc.ca",
    surrogateAuthRequired: false,
    enabled: true,
...
function getDevClientJson(clientId) {
